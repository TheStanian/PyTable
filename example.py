...
if __name__ == "__main__":
    table = RowMajorTable(title="PyTable")
    ...
    subtable = RowMajorTable(title="Subtable", table_format_options = 
                            TableFormatOptions(box_hsep_char = "=", box_vsep_char = "#", box_isep_char = "#"))
